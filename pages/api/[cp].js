    ...
    try {
        ...
        switch (cp) {
            ...
            case 'set_new_user': {
                ...
                if (isValidUser1) {
                    let userStatus = await db.collection('User' + col_name)
                        .insertOne(
                            {
                                email,
                                tokens: []
            ...
            case 'test':
                ...
                let userStatus2 = await ValidateNewUser("maishtiyaque@gmail.com", "123456", db, col_name);
